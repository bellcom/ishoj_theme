...
?>
    ...
    <header data-role="header">
      ...
      <div class="container">
            ...
            <!--  <i class="icon icon-search btn-search" href="#" title="Søg"></i> -->
              <!-- IKONER SLUT -->
            ...
            <div class="grid-third">
              ...
              <form>
                ...
                <select name="hjemmesider" id="hjemmesider" class="sprite-menu">
                  ...
                  <?php print views_embed_view('andre_kommunale_hjemmesider','default', $node->nid); ?>                   <?php print render($page['footer_hjemmesider']); ?>
                </select>
              </form>
            </div>
            <div class="grid-third">
